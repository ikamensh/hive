...
HIVE_SUBSTRATE_PROVIDER=${HIVE_SUBSTRATE_PROVIDER:-}
HIVE_SUBSTRATE_INSTANCE_ID=${HIVE_SUBSTRATE_INSTANCE_ID:-}
HIVE_SUBSTRATE_ZONE=${HIVE_SUBSTRATE_ZONE:-}
HIVE_POWER_POLICY=${HIVE_POWER_POLICY:-}
