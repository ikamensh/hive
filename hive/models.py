...
class Task(BaseModel):
    ...
    continuation_attempts: int = 0  # bounded successors for unfinished execution/reporting
    incomplete_reason: str = ""  # transport or report evidence that work needs continuation
